...
function Popup() {
    ...
    browser.tabs.query({ active: true, currentWindow: true }).then((tabs) => {
      ...
      if (tabs[0]) {
        ...
        browser.runtime.sendMessage({
          ...
          console.log("Got active settings:", settings);
          if (settings) {
            setState(s => ({
              ...s,
  ...
  return (
    <div className="p-3">
      <h3 className="text-center mb-2">Color Rewriter</h3>
...
// Also try immediate rendering as a fallback
try {
  const rootDiv = document.getElementById("root");
  if (rootDiv) {
  ...
  console.error("Error during immediate render:", e);
}